...
<body>
  ...
  <div class="container d-flex justify-content-center my-3" style="min-height: 100vh;">
    <form action="<?php echo base_url() . 'user/signin'; ?>" method="post" class="border bg-light shadow p-3 rounded" style="width:450px; height:600px;">
      ...
      <div class="form-group">
        ...
        <input type="text" name="address" placeholder=" enter your address" class="form-control my-3">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" name="cpasword" placeholder=" enter your Conform-password" class="form-control my-3">
      </div>
